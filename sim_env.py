...
def make_sim_env(task_name):
    ...
    if 'sim_transfer_cube' in task_name:
        ...
        xml_path = os.path.join(XML_DIR, f'modified_env.xml')
        physics = mujoco.Physics.from_xml_path(xml_path)
...
class TransferCubeTask(BimanualViperXTask):
    ...
    def initialize_episode(self, physics):
        ...
        with physics.reset_context():
            ...
            physics.named.data.qpos[-7:] = BOX_POSE[0] #Set position of the box
            # print(f"{BOX_POSE=}")
        super().initialize_episode(physics)
    ...
    def get_reward(self, physics):
        ...
        touch_left_gripper = ("red_box", "finger_left") in all_contact_pairs
        touch_right_gripper = ("red_box", "finger_right") in all_contact_pairs
        touch_table = ("red_box", "table") in all_contact_pairs
