...
class DiffusionConfig:
    ...
    input_shapes: Dict[str, List[int]] = field(
        default_factory=lambda: {
            "observation.images.front_close": [3, 480, 640],
            "observation.images.gripper_top": [3, 480, 640],
    ...
    input_normalization_modes: Dict[str, str] = field(
        default_factory=lambda: {
            "observation.images.front_close": "mean_std",
            "observation.images.gripper_top": "mean_std",
            "observation.images.top":"mean_std", 
            "observation.state": "min_max",
        }
    )
    output_normalization_modes: Dict[str, str] = field(default_factory=lambda: {"actions": "min_max"})
    ...
    def __post_init__(self):
        ...
        image_keys = {k for k in self.input_shapes if k.startswith("observation.images")}
